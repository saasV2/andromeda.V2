...
menu_instalador(){
    ...
    echo -e "${branco}  '-->${roxo}[ 3.1 ]${reset} - ${branco}Evolution API (ARM)              ${roxo}| ${reset}  ${roxo}[ 26 ]${reset} - ${branco}Chatwoot Nestor${reset}"
    ...
    echo -e "${roxo}[ 15 ]${reset} - ${branco}Uptime Kuma                             ${roxo}| ${reset}  ${roxo}[ 38 ]${reset} - ${branco}Strapi${reset}"
    echo -e "${roxo}[ 16 ]${reset} - ${branco}Cal.com                                 ${roxo}| ${reset}  ${roxo}[ 39 ]${reset} - ${branco}PhpMyAdmin${reset}"
    echo -e "${roxo}[ 17 ]${reset} - ${branco}Mautic                                  ${roxo}| ${reset}  ${roxo}[ 40 ]${reset} - ${branco}Supabase ${roxo}[NOVO]${reset}"
    echo -e "${roxo}[ 18 ]${reset} - ${branco}Appsmith                                ${roxo}| ${reset}  ${roxo}[ 41 ]${reset} - ${branco}REMOVER STACK${reset}"
    echo -e "${roxo}[ 19 ]${reset} - ${branco}Qdrant                                  ${roxo}| ${reset}  ${roxo}[ 42 ]${reset} - ${branco}Sair do instalador${reset}"
