...
direitos_setup() {
    ...
    echo -e "\e[38;5;118m||                                                                                                         ||\e[0m"
    echo -e "\e[38;5;118m||  ${branco}Este é um instalador automatizado desenvolvido para simplificar a instalação das principais            \e[38;5;118m||\e[0m"
    echo -e "\e[38;5;118m||  ${branco}aplicações de código aberto disponíveis. Todos os créditos são atribuídos aos desenvolvedores          \e[38;5;118m||\e[0m"
    echo -e "\e[38;5;118m||  ${branco}de cada aplicação incluída. Este instalador é licenciado sob a Licença MIT (MIT), permitindo que       \e[38;5;118m||\e[0m"
    echo -e "\e[38;5;118m||  ${branco}você copie, modifique, integre, publique, distribua e/ou venda cópias dos produtos finais. No          \e[38;5;118m||\e[0m"
    echo -e "\e[38;5;118m||  ${branco}entanto, é obrigatório atribuir a autoria original à Sinergia Lucrativa (\e[1m${azul}suporte@sinergialucrativa.com\e[0m${branco})\e[38;5;118m||\e[0m"
    echo -e "\e[38;5;118m||  ${branco}e fornecer um link para \e[1m${azul}https://www.instagram.com/binho_v1/\e[0m${branco}.                                           \e[38;5;118m||\e[0m"
    echo -e "\e[38;5;118m||                                                                                                         ||\e[0m"
    echo -e "\e[38;5;118m=============================================================================================================\e[0m"
    echo ""
    echo ""
...
info_credenciais(){ 
    echo -e "\e[38;5;118m===================================================================================================\e[0m"
    echo -e "\e[38;5;118m=                                                                                                 =\e[0m"
    echo -e "\e[38;5;118m=  \e[97mA partir da versão 2.5.0 deste Setup foi implementado uma função para realizar deploy dentro \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=  \e[97mdo proprio portainer através de uma requsição api. Para que esta nova função funcione em   \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=  \e[97msuas proximas instalações, você precisará informar às credenciais de acesso do seu portainer \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=                                                                                                 =\e[0m"
    echo -e "\e[38;5;118m===================================================================================================\e[0m"
    echo ""
    echo ""
...
creditos_msg() {
    ...
    echo ""
    echo -e "\e[38;5;118m===================================================================================================\e[0m"
    echo -e "\e[38;5;118m=                                                                                                 \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=          \e[97mGostaria de contribuir para continuarmos o desenvolvimento deste projeto?            \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=          \e[97m                    Você pode fazer uma doação via PIX:                                \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=                                                                                                 \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=                                      suporte@sinergialucrativa                                  \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=                                                                                                 \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=          \e[97m         Se precisar de ajuda/mentoria ou quiser deixar seu feedback                   \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=          \e[97m               WhatsApp : \e[38;5;118m48991741999                                                  \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=                                                                                                 \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=          \e[97m                    ou (comunidade Setup Andromeda v1)                                 \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=          \e[38;5;118m               https://chat.whatsapp.com/Ez8z14o9SxV1w1Ya3clxtM                        \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m=                                                                                                 \e[38;5;118m=\e[0m"
    echo -e "\e[38;5;118m===================================================================================================\e[0m"
    echo ""
    echo ""
...
nome_menu() {
    ...
    echo -e "\e[38;5;118m========================================================================================\e[0m"
    echo ""
    echo -e "\e[38;5;118m                        \e[38;5;196m███╗   ███╗███████╗███╗   ██╗██╗   ██╗\e[0m                    "
    echo -e "\e[38;5;118m                        \e[38;5;196m████╗ ████║██╔════╝████╗  ██║██║   ██║\e[0m                    "
    echo -e "\e[38;5;118m                        \e[38;5;196m██╔████╔██║█████╗  ██╔██╗ ██║██║   ██║\e[0m                    "
    echo -e "\e[38;5;118m                        \e[38;5;196m██║╚██╔╝██║██╔══╝  ██║╚██╗██║██║   ██║\e[0m                    "
    echo -e "\e[38;5;118m                        \e[38;5;196m██║ ╚═╝ ██║███████╗██║ ╚████║╚██████╔╝\e[0m                    "
...
menu_instalador(){
    echo ""
    echo -e "${verde}[ 0 ]${reset} -  ${branco}Testar SMTP                             ${verde}| ${reset}  ${verde}[ 21 ]${reset} - ${branco}Formbricks${reset}"
    echo -e "${verde}[ 1 ]${reset} -  ${branco}Traefik & Portainer                     ${verde}| ${reset}  ${verde}[ 22 ]${reset} - ${branco}NocoDB${reset}"
    echo -e "${verde}[ 2 ]${reset} -  ${branco}Chatwoot                                ${verde}| ${reset}  ${verde}[ 23 ]${reset} - ${branco}Langfuse${reset}"
    echo -e "${branco}  '-->${verde}[ 2.1 ]${reset} - ${branco}Chatwoot (ARM)                   ${verde}| ${reset}  ${verde}[ 24 ]${reset} - ${branco}Metabase${reset}"
    echo -e "${verde}[ 3 ]${reset} -  ${branco}Evolution API                           ${verde}| ${reset}  ${verde}[ 25 ]${reset} - ${branco}Odoo${reset}"
    echo -e "${branco}  '-->${verde}[ 3.1 ]${reset} - ${branco}Evolution API (ARM)              ${verde}| ${reset}  ${verde}[ 26 ]${reset} - ${branco}Chatwoot Nestor${reset}"
    echo -e "${verde}[ 4 ]${reset} -  ${branco}MinIO                                   ${verde}| ${reset}  ${verde}[ 27 ]${reset} - ${branco}Uno API${reset}"
    echo -e "${verde}[ 5 ]${reset} -  ${branco}Typebot                                 ${verde}| ${reset}  ${verde}[ 28 ]${reset} - ${branco}N8N + Nodes Quepasa${reset}"
    echo -e "${verde}[ 6 ]${reset} -  ${branco}N8N                                     ${verde}| ${reset}  ${verde}[ 29 ]${reset} - ${branco}Quepasa API${reset}"
    echo -e "${verde}[ 7 ]${reset} -  ${branco}Flowise                                 ${verde}| ${reset}  ${verde}[ 30 ]${reset} - ${branco}Docuseal${reset}"
    echo -e "${verde}[ 8 ]${reset} -  ${branco}PgAdmin 4                               ${verde}| ${reset}  ${verde}[ 31 ]${reset} - ${branco}Grafana + Prometheus + cAdvisor${reset}"
    echo -e "${verde}[ 9 ]${reset} -  ${branco}Nocobase                                ${verde}| ${reset}  ${verde}[ 32 ]${reset} - ${branco}Dify AI${reset}"
    echo -e "${verde}[ 10 ]${reset} - ${branco}Botpress                                ${verde}| ${reset}  ${verde}[ 33 ]${reset} - ${branco}Ollama${reset}"
    echo -e "${verde}[ 11 ]${reset} - ${branco}Wordpress                               ${verde}| ${reset}  ${verde}[ 34 ]${reset} - ${branco}Affine${reset}"
    echo -e "${verde}[ 12 ]${reset} - ${branco}Baserow                                 ${verde}| ${reset}  ${verde}[ 35 ]${reset} - ${branco}Directus${reset}"
    echo -e "${verde}[ 13 ]${reset} - ${branco}MongoDB                                 ${verde}| ${reset}  ${verde}[ 36 ]${reset} - ${branco}VaultWarden${reset}"
    echo -e "${verde}[ 14 ]${reset} - ${branco}RabbitMQ                                ${verde}| ${reset}  ${verde}[ 37 ]${reset} - ${branco}NextCloud${reset}"
    echo -e "${verde}[ 15 ]${reset} - ${branco}Uptime Kuma                             ${verde}| ${reset}  ${verde}[ 38 ]${reset} - ${branco}Strapi${reset}"
    echo -e "${verde}[ 16 ]${reset} - ${branco}Cal.com                                 ${verde}| ${reset}  ${verde}[ 39 ]${reset} - ${branco}PhpMyAdmin${reset}"
    echo -e "${verde}[ 17 ]${reset} - ${branco}Mautic                                  ${verde}| ${reset}  ${verde}[ 40 ]${reset} - ${branco}Supabase ${verde}[NOVO]${reset}"
    echo -e "${verde}[ 18 ]${reset} - ${branco}Appsmith                                ${verde}| ${reset}  ${verde}[ 41 ]${reset} - ${branco}REMOVER STACK${reset}"
